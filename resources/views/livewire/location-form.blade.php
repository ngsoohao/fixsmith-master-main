<div class="flex-row mt-10">
    ...
    <div class="p-5 pr-5 mr-10 border-2 rounded-md border-slate-500">
        <div class="space-y-4 ">
            ...
            <div class="flex items-center form-group">
                ...
                <div class="relative">
                    <select wire:model="state" class="mt-2 bg-white border rounded-md input-field ">
                        <option class="hover:bg-slate-800 focus:bg-slate-800" value="" disabled>Select State</option>
                        @foreach($malaysiaStates as $malaysiaState)
                            <option
                                class="hover:text-white hover:bg-slate-800 focus:bg-slate-700"
                                value="{{ $malaysiaState }}"
                            >
                                {{ $malaysiaState }}
                            </option>
                    ...
                    <div class="flex items-end justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        <div class="inline-block overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                            ...
                            <div class="px-4 py-3 bg-gray-50 sm:px-6 sm:flex sm:flex-row-reverse">
                                ...
                                <button wire:click="deleteLocation()" type="button" class="inline-flex justify-center w-full px-4 py-2 text-base font-medium text-white bg-red-600 border border-transparent rounded-md shadow-sm hover:bg-red-700 focus:outline-none sm:ml-3 sm:w-auto sm:text-sm">
                                    Delete
                                </button>
